...
describe('API Response Utilities', () => {
  ...
  describe('errorResponse', () => {
    it('should create an error response with code and message', () => {
      const response = errorResponse('INVALID_INPUT', 'Query parameter is required');
    ...
    it('should create an error response with details', () => {
      ...
      const response = errorResponse('INVALID_INPUT', 'Validation failed', details);
  ...
  describe('isSuccessResponse', () => {
    ...
    it('should narrow type correctly', () => {
      const response: ApiResponse<{ id: string }> = successResponse({ id: '1' });
  ...
  describe('isErrorResponse', () => {
    ...
    it('should narrow type correctly', () => {
      const response: ApiResponse<string> = errorResponse('UNAUTHORIZED', 'Not logged in');

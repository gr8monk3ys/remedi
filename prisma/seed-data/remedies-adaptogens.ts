...
export const adaptogenRemedies = [
  {
    ...
    description:
      "Classic adaptogen supporting stress resilience, physical endurance, and immune function.",
    category: "Adaptogen",
    ...
    usage:
      "Take in morning. Can be used long-term. Cycle 8 weeks on, 2 weeks off.",
    dosage: "300-1200 mg extract daily standardized to eleutherosides",
    precautions:
      "May interact with blood thinners and diabetes medications. Avoid with high blood pressure.",
    scientificInfo:
      "Eleutherosides modulate HPA axis response and support immune cell function. Unlike true ginseng, does not contain ginsenosides.",
  ...
  },
  {
    ...
    description:
      "Renowned root supporting energy, cognitive function, and overall vitality.",
    category: "Adaptogen",
    ...
    usage:
      "Morning dosing preferred. Red ginseng is steamed, more warming. Cycle use recommended.",
    dosage: "200-400 mg standardized extract daily; or 1-2 g root powder",
    precautions:
      "May be stimulating. Avoid with insomnia, anxiety, or hypertension. May interact with blood thinners and diabetes medications.",
    scientificInfo:
      "Ginsenosides modulate multiple signaling pathways including nitric oxide production, HPA axis, and immune function.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Cooler, more calming ginseng variety supporting energy, immunity, and blood sugar.",
    category: "Adaptogen",
    ...
    precautions:
      "May affect blood sugar. Interact with diabetes medications and warfarin.",
    scientificInfo:
      "American ginseng has higher Rb1:Rg1 ratio than Asian ginseng, contributing to its calmer energizing effects.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Five-flavor berry supporting liver health, stress adaptation, and mental performance.",
    category: "Adaptogen",
    ...
    scientificInfo:
      "Schisandrins have hepatoprotective effects and modulate cortisol. The five flavors reflect actions on all five organ systems in TCM.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Prized functional mushroom supporting energy, athletic performance, and respiratory function.",
    category: "Adaptogen",
    ...
    usage:
      "Take in morning or before exercise. CS-4 and militaris are cultivated forms.",
    dosage: "1000-3000 mg daily",
    precautions:
      "May interact with immunosuppressants. Caution in autoimmune conditions.",
    scientificInfo:
      "Cordycepin enhances ATP production and oxygen utilization. Traditional use for kidney and lung support.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Mushroom of immortality in TCM, supporting immune balance, sleep, and stress resilience.",
    category: "Adaptogen",
    ingredients: JSON.stringify([
      "Triterpenoids",
      "Beta-glucans",
    ...
    precautions:
      "May interact with blood thinners and immunosuppressants. Rare liver toxicity reported with some products.",
    scientificInfo:
      "Beta-glucans modulate immune cell activity. Triterpenoids have anti-inflammatory and hepatoprotective effects.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Brain-supporting mushroom promoting nerve growth factor and cognitive function.",
    category: "Adaptogen",
    ...
    precautions:
      "Generally well tolerated. May cause itchy skin in sensitive individuals.",
    scientificInfo:
      "Hericenones and erinacines stimulate nerve growth factor (NGF) synthesis, supporting neurogenesis and myelin formation.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Chaga Mushroom",
    description:
      "Siberian fungus with powerful antioxidant and immune-supporting properties.",
    category: "Adaptogen",
    ingredients: JSON.stringify([
      "Betulinic acid",
      "Beta-glucans",
    ...
    usage:
      "Traditionally prepared as tea. Dual extraction captures all compounds.",
    dosage: "1000-3000 mg daily or 1-2 cups tea",
    precautions:
      "May lower blood sugar. High oxalate content - caution with kidney stones.",
    scientificInfo:
      "Chaga has one of the highest ORAC values among foods. Betulinic acid from birch trees has unique biological activity.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Colorful polypore mushroom with extensive research for immune support, especially during cancer treatment.",
    category: "Adaptogen",
    ingredients: JSON.stringify([
    ...
    dosage: "1000-3000 mg daily",
    precautions:
      "May interact with immunosuppressants. Discuss with oncologist if using during cancer treatment.",
    scientificInfo:
      "PSK is approved in Japan as adjunctive cancer therapy. Enhances natural killer cell activity and gut microbiome.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Hen of the woods mushroom supporting immune function and metabolic health.",
    category: "Adaptogen",
    ingredients: JSON.stringify([
      "D-fraction",
      "Beta-glucans",
    ...
    usage:
      "Can be consumed as food or supplement. D-fraction is concentrated extract.",
    ...
    scientificInfo:
      "Maitake D-fraction activates macrophages, dendritic cells, and natural killer cells. May improve insulin sensitivity.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Culinary and medicinal mushroom supporting immune function and cardiovascular health.",
    category: "Adaptogen",
    ...
    precautions:
      "Raw shiitake can cause dermatitis in some people. Cook before eating.",
    scientificInfo:
      "Lentinan is approved in Japan as adjunctive cancer therapy. Eritadenine has cholesterol-lowering effects.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Ayurvedic brain tonic herb supporting memory, learning, and cognitive longevity.",
    category: "Adaptogen",
    ingredients: JSON.stringify([
      "Bacosides A and B",
      "Bacopasides",
    ...
    usage:
      "Take with food (fat enhances absorption). Effects build over 8-12 weeks.",
    dosage: "300-450 mg daily standardized to 55% bacosides",
    precautions:
      "May cause GI upset. Start with lower doses. May have mild sedative effect.",
    scientificInfo:
      "Bacosides enhance synaptic communication and have antioxidant effects in the hippocampus. Modulates serotonin and acetylcholine.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Gotu Kola",
    description:
      "Brain and longevity herb from Ayurveda supporting cognition, circulation, and wound healing.",
    category: "Adaptogen",
    ingredients: JSON.stringify([
      "Asiaticoside",
      "Madecassoside",
    ...
    precautions:
      "May cause drowsiness. Rare liver toxicity reported with prolonged high-dose use.",
    scientificInfo:
      "Triterpenoids stimulate collagen synthesis and have anxiolytic effects. Enhances GABA activity.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Natural source of L-DOPA supporting dopamine levels, mood, and libido.",
    category: "Adaptogen",
    ...
    precautions:
      "Do not combine with MAOIs or Parkinsons medications without medical supervision. May affect blood sugar.",
    scientificInfo:
      "L-DOPA crosses blood-brain barrier and is converted to dopamine. Also reduces cortisol and prolactin in some studies.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Shilajit",
    description:
      "Ancient mineral-rich substance from Himalayan rocks supporting energy, testosterone, and vitality.",
    category: "Adaptogen",
    ingredients: JSON.stringify([
      "Fulvic acid",
      "Humic acid",
    ...
    precautions:
      "Use only purified forms tested for heavy metals. May affect iron metabolism.",
    scientificInfo:
      "Fulvic acid enhances nutrient absorption and has antioxidant effects. Dibenzo-alpha-pyrones support CoQ10 and ATP production.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Malaysian herb supporting testosterone, libido, and physical performance.",
    category: "Adaptogen",
    ...
    precautions:
      "May affect hormone levels. Not for use with hormone-sensitive conditions.",
    scientificInfo:
      "Eurycomanone may support testosterone by reducing SHBG and cortisol. Adaptogenic effects on HPA axis.",
    references: JSON.stringify([

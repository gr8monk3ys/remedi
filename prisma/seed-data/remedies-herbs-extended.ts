...
export const extendedHerbalRemedies = [
  // TCM Herbs
  {
    ...
    description:
      "Female ginseng in TCM, used for menstrual and menopausal support.",
    category: "Herbal",
    ...
    precautions:
      "Avoid during pregnancy. May increase bleeding risk. Photosensitivity possible.",
    scientificInfo:
      "Dong quai has blood-building and circulation-enhancing properties in TCM. Contains ferulic acid with antioxidant effects.",
  ...
  },
  {
    name: "Burdock Root",
    description:
      "Detoxifying root used for skin health and blood purification.",
    category: "Herbal",
    ...
    scientificInfo:
      "Burdock root contains inulin prebiotic fiber and arctigenin with anti-inflammatory properties.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "Oxindole alkaloids modulate immune cell activity. Has been studied for inflammatory conditions.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Red Clover",
    description:
      "Isoflavone-rich herb for menopausal symptoms and cardiovascular support.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Isoflavones",
      "Genistein",
    ...
    precautions:
      "Avoid with hormone-sensitive conditions. May interact with blood thinners.",
    scientificInfo:
      "Red clover isoflavones bind to estrogen receptors with selective effects on different tissues.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "Vitex acts on the pituitary to modulate prolactin and support progesterone production.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "May deplete thiamine with long-term use. Supplement B1 if using long-term.",
    scientificInfo:
      "Horsetail provides bioavailable silica important for collagen cross-linking and bone matrix.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Nettle Root",
    description:
      "Root extract specifically for prostate and urinary health in men.",
    category: "Herbal",
    ...
    usage:
      "Root extract is different from leaf. Often combined with saw palmetto.",
    dosage: "300-600 mg root extract daily",
    precautions: "May interact with diabetes and blood pressure medications.",
    scientificInfo:
      "Nettle root contains compounds that inhibit SHBG binding and aromatase, supporting prostate health.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "African bark extract for prostate health and urinary symptoms.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Phytosterols",
      "Triterpenes",
    ...
    scientificInfo:
      "Pygeum inhibits 5-alpha reductase and has anti-inflammatory effects on prostate tissue.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "Very rare sitosterolemia condition. May reduce absorption of some medications.",
    scientificInfo:
      "Beta-sitosterol improves urinary symptoms by reducing inflammation in prostate tissue.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "Hops metabolites enhance GABA activity. 8-prenylnaringenin has phytoestrogenic effects.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Gentle calming herb from the mint family for relaxation and digestion.",
    category: "Herbal",
    ...
    scientificInfo:
      "Nepetalactone has mild sedative effects in humans, unlike its stimulating effect on cats.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Nervine herb for anxiety, tension, and nervous system support.",
    category: "Herbal",
    ...
    precautions:
      "May enhance sedatives. Rare liver concerns with adulterated products.",
    scientificInfo:
      "Baicalin and other flavonoids modulate GABA-A receptors and have anxiolytic effects.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "Contains mild sedative alkaloids that act on GABA and opioid receptors without addictive properties.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      'Contains compounds with mild sedative and analgesic effects, traditionally called "lettuce opium."',
    references: JSON.stringify([
  ...
  },
  {
    name: "Corydalis",
    description:
      "TCM herb for pain relief with alkaloids that affect dopamine receptors.",
    category: "Herbal",
    ...
    precautions:
      "May cause sedation. Avoid with CNS depressants. Not for long-term use.",
    scientificInfo:
      "Dehydrocorybulbine (DHCB) has analgesic effects through dopamine receptor modulation without opioid action.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Blue Vervain",
    description:
      "Nervine herb for stress, tension headaches, and digestive support.",
    category: "Herbal",
    ...
    scientificInfo:
      "Iridoid glycosides have calming effects on the nervous system and support digestion.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "Wood betony has been used for centuries for nervous conditions and headaches.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "Not for long-term use. Endangered - choose cultivated sources. Avoid during pregnancy.",
    scientificInfo:
      "Contains berberine with antimicrobial and metabolic effects. Hydrastine supports mucosal membranes.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Berberine-containing herb for skin conditions and digestive support.",
    category: "Herbal",
    ...
    scientificInfo:
      "Berberine and other alkaloids have anti-inflammatory and antimicrobial effects beneficial for skin.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "Avoid during pregnancy. May cause allergic reactions in those sensitive to Asteraceae.",
    scientificInfo:
      "Yarrow has hemostatic, anti-inflammatory, and antimicrobial properties. Named after Achilles.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Skin-healing herb for wounds, inflammation, and digestive support.",
    category: "Herbal",
    ...
    precautions:
      "May cause allergic reactions in those sensitive to Asteraceae. Avoid internal use during pregnancy.",
    scientificInfo:
      "Triterpenoids promote wound healing by stimulating epithelialization and angiogenesis.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "Aucubin has anti-inflammatory and antimicrobial effects. Mucilage soothes irritated tissues.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Lymphatic-supporting herb for detoxification and skin health.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Iridoids",
      "Flavonoids",
    ...
    scientificInfo:
      "Cleavers supports lymphatic drainage and has mild diuretic properties.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "High oxalate content - caution with kidney stones. May cause loose stools.",
    scientificInfo:
      "Yellow dock enhances iron absorption and has gentle bitter digestive properties.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "Strain tea well to remove irritating hairs. Use ear oil only with intact eardrum.",
    scientificInfo:
      "Saponins have expectorant effects while mucilage soothes irritated respiratory tissue.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "May cause allergic reactions in those sensitive to Asteraceae.",
    scientificInfo:
      "Sesquiterpene lactones have expectorant and antimicrobial properties for respiratory infections.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Thyme",
    description:
      "Culinary herb with powerful antimicrobial and respiratory benefits.",
    category: "Herbal",
    ...
    scientificInfo:
      "Thymol has broad-spectrum antimicrobial activity and supports respiratory function.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    dosage:
      "Steam inhalation as needed; 200-600 mg cineole-standardized extract",
    precautions:
      "Do not apply to face of young children. Internal use of essential oil requires proper formulation.",
    scientificInfo:
      "1,8-cineole has mucolytic, bronchodilator, and anti-inflammatory effects.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "Not for internal use. May cause skin irritation. Test on small area first.",
    scientificInfo:
      "Terpinen-4-ol provides broad-spectrum antimicrobial activity against bacteria, fungi, and viruses.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "May interact with blood thinners. Avoid high doses during pregnancy.",
    scientificInfo:
      "Carnosic acid is a potent antioxidant. Rosemary oil may promote hair growth comparable to minoxidil.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "Sage inhibits acetylcholinesterase, supporting memory. Also has estrogenic effects for hot flashes.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "A-type proanthocyanidins prevent E. coli adhesion to urinary tract walls.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "Not for long-term use. Requires alkaline urine for activation. Not during pregnancy.",
    scientificInfo:
      "Arbutin is converted to hydroquinone in alkaline urine, providing antimicrobial activity.",
    references: JSON.stringify([
  ...
  },
  {
    name: "D-Mannose",
    description:
      "Natural sugar that prevents bacteria from adhering to urinary tract.",
    category: "Specialty Nutrient",
    ingredients: JSON.stringify(["D-Mannose"]),
    benefits: JSON.stringify([
      "UTI prevention",
      "UTI treatment support",
      "Urinary health",
    ]),
    usage: "Dissolve in water. Take preventively or at first sign of UTI.",
    dosage:
      "500 mg two times daily preventively; 500 mg every 2-3 hours acutely",
    precautions: "May cause loose stools. Monitor blood sugar if diabetic.",
    scientificInfo:
      "D-mannose binds to E. coli fimbriae, preventing bacterial adhesion to urinary tract epithelium.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Blessed seed with broad therapeutic properties from Middle Eastern tradition.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Thymoquinone",
      "Thymohydroquinone",
    ...
    precautions:
      "May enhance effects of blood sugar and blood pressure medications.",
    scientificInfo:
      "Thymoquinone has potent anti-inflammatory and antioxidant effects. Traditional use for almost everything.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "Moringa is exceptionally nutrient-dense with protein, vitamins, minerals, and beneficial plant compounds.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Neem",
    description:
      "Ayurvedic bitter herb for skin, blood sugar, and oral health.",
    category: "Herbal",
    ...
    scientificInfo:
      "Neem has broad antimicrobial and anti-inflammatory properties. Used for dental care in traditional practice.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Spearmint",
    description:
      "Gentle mint for digestive comfort and hormone balance in women.",
    category: "Herbal",
    ...
    scientificInfo:
      "Spearmint tea has anti-androgenic effects and may help reduce excess hair growth in women with PCOS.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Fennel",
    description:
      "Digestive herb for bloating, colic, and breastfeeding support.",
    category: "Herbal",
    ...
    precautions:
      "Has mild estrogenic effects. Avoid in estrogen-sensitive conditions.",
    scientificInfo:
      "Anethole has carminative effects and mild estrogenic activity supporting lactation.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "Carvone has spasmolytic effects on intestinal smooth muscle.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Fringetree",
    description:
      "Liver and gallbladder supportive herb from Native American tradition.",
    category: "Herbal",
    ...
    scientificInfo:
      "Traditionally used to support liver and gallbladder function and stimulate digestion.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "Avoid with gastric ulcers or GERD. Do not use during pregnancy.",
    scientificInfo:
      "Bitter compounds stimulate digestive secretions through bitter taste receptors in the gut.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions: "Generally very safe.",
    scientificInfo:
      "Tannins provide astringent effects useful for diarrhea and wound healing.",
    references: JSON.stringify([
      "Newall CA, et al. Herbal Medicines: A Guide for Health-Care Professionals. Pharmaceutical Press. 1996.",
    ]),
    relatedRemedies: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "Anti-inflammatory and astringent properties may support eye and upper respiratory health.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    scientificInfo:
      "Anthocyanosides support rhodopsin regeneration and capillary integrity.",
    references: JSON.stringify([

...
export const herbalRemedies = [
  {
    ...
    description:
      "Golden spice containing curcumin, a powerful anti-inflammatory and antioxidant compound used for centuries in traditional medicine.",
    category: "Herbal",
    ...
    dosage:
      "500-2000 mg turmeric extract standardized to 95% curcuminoids daily",
    precautions:
      "May interact with blood thinners and diabetes medications. Avoid before surgery. May worsen gallbladder issues.",
    scientificInfo:
      "Curcumin inhibits NF-kB, COX-2, and other inflammatory mediators. Its bioavailability is enhanced 2000% with piperine.",
  ...
  },
  {
    name: "Ginger Root",
    description:
      "Versatile root with anti-inflammatory, digestive, and anti-nausea properties used worldwide.",
    category: "Herbal",
    ...
    precautions:
      "May increase bleeding risk. Use caution with blood thinners. May affect blood sugar.",
    scientificInfo:
      "Gingerols inhibit prostaglandin and leukotriene synthesis. Ginger acts on 5-HT3 receptors for anti-nausea effects.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Premier adaptogenic herb from Ayurvedic medicine for stress resilience, energy, and hormone balance.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Withanolides",
      "Withaferin A",
    ...
    dosage:
      "300-600 mg standardized extract daily; up to 1000 mg for specific conditions",
    precautions:
      "May affect thyroid hormone levels. Avoid during pregnancy. May have sedative effects.",
    scientificInfo:
      "Withanolides modulate cortisol, support GABA signaling, and have neuroprotective effects. Shown to reduce cortisol by 25-30%.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Valerian Root",
    description:
      "Traditional sleep-promoting herb that supports relaxation and healthy sleep patterns.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Valerenic acid",
      "Isovaleric acid",
    ...
    usage:
      "Take 30-60 minutes before bedtime. May take 2-4 weeks for full effects.",
    dosage: "300-600 mg standardized extract before bed",
    precautions:
      "May cause morning grogginess. Avoid combining with sedatives or alcohol. Discontinue 2 weeks before surgery.",
    scientificInfo:
      "Valerenic acid inhibits GABA breakdown and enhances GABA receptor binding, promoting relaxation and sleep.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Well-researched herb for mild to moderate mood support, with centuries of traditional use.",
    category: "Herbal",
    ...
    precautions:
      "MAJOR drug interactions with antidepressants, birth control, blood thinners, HIV medications. Causes photosensitivity. Do not combine with prescription antidepressants.",
    scientificInfo:
      "Hyperforin inhibits reuptake of serotonin, dopamine, norepinephrine, GABA, and glutamate. Comparable to SSRIs for mild-moderate depression.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Echinacea",
    description:
      "Popular immune-supporting herb used to reduce duration and severity of colds.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Alkylamides",
      "Polysaccharides",
    ...
    usage:
      "Most effective when started at first sign of illness. Can be taken as tea, tincture, or capsules.",
    dosage:
      "300-500 mg three times daily; or 2.5 mL tincture three times daily",
    precautions:
      "May cause allergic reactions in those sensitive to ragweed. Not recommended for autoimmune conditions.",
    scientificInfo:
      "Echinacea alkylamides modulate immune cell activity and cytokine production. May reduce cold duration by 1-4 days.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Dark purple berry rich in anthocyanins with potent antiviral and immune-supporting properties.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Anthocyanins",
      "Flavonoids",
    ...
    usage:
      "Take at first sign of illness. Available as syrup, lozenges, or capsules.",
    dosage:
      "15 mL syrup four times daily or 175 mg extract twice daily during illness",
    precautions:
      "Raw elderberries are toxic; use only properly prepared products. May stimulate immune system; caution in autoimmune conditions.",
    scientificInfo:
      "Elderberry anthocyanins inhibit viral entry and replication. Studies show reduced flu duration by 3-4 days.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Premier liver-supporting herb containing silymarin complex, traditionally used for hepatoprotection.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Silymarin",
      "Silybin",
    ...
    usage:
      "Take with meals. Phosphatidylcholine-bound forms (Siliphos) have better absorption.",
    dosage: "200-400 mg silymarin extract two to three times daily",
    precautions:
      "May lower blood sugar. May have estrogenic effects. Rare allergic reactions in ragweed-sensitive individuals.",
    scientificInfo:
      "Silymarin protects hepatocytes by stabilizing cell membranes, promoting protein synthesis, and scavenging free radicals.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Rhodiola Rosea",
    description:
      "Arctic adaptogen that enhances stress resilience, mental performance, and physical endurance.",
    category: "Herbal",
    ...
    usage:
      "Take in morning on empty stomach. Avoid evening use due to stimulating effects.",
    dosage: "200-600 mg daily standardized to 3% rosavins and 1% salidroside",
    precautions:
      "May be stimulating; avoid in anxiety or bipolar disorder. May interact with antidepressants.",
    scientificInfo:
      "Rhodiola modulates cortisol, enhances ATP synthesis, and affects monoamine neurotransmitters including serotonin and dopamine.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Ginkgo Biloba",
    description:
      "Ancient tree extract supporting cerebral circulation, cognitive function, and memory.",
    category: "Herbal",
    ingredients: JSON.stringify([
    ...
    dosage:
      "120-240 mg daily standardized to 24% flavone glycosides and 6% terpene lactones",
    precautions:
      "May increase bleeding risk. Discontinue before surgery. May interact with blood thinners and anticonvulsants.",
    scientificInfo:
      "Ginkgo improves microcirculation, has antioxidant effects, and modulates neurotransmitter systems including acetylcholine.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Saw Palmetto",
    description:
      "Berry extract traditionally used for prostate health and urinary symptoms in men.",
    category: "Herbal",
    ...
    precautions:
      "May affect PSA levels. Inform urologist of use. May have hormonal effects.",
    scientificInfo:
      "Saw palmetto inhibits 5-alpha reductase, reducing conversion of testosterone to DHT. May reduce prostate inflammation.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Calming herb traditionally used for anxiety, sleep support, and nervous tension.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Chrysin",
      "Flavonoids",
    ...
    usage:
      "Take before bed for sleep or during day for anxiety. Can be taken as tea or extract.",
    dosage: "250-500 mg extract daily or 1-2 cups tea",
    precautions:
      "May enhance sedative effects of medications. Avoid combining with sedatives or alcohol.",
    scientificInfo:
      "Passionflower increases GABA levels in the brain through GABA-A receptor binding and MAO inhibition.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Gentle calming herb from the mint family, traditionally used for anxiety, sleep, and digestive comfort.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Rosmarinic acid",
      "Flavonoids",
    ...
    usage:
      "Can be taken as tea, tincture, or capsules. Topical forms for cold sores.",
    dosage: "300-600 mg extract daily or 1.5-4.5 g dried herb as tea",
    precautions:
      "May affect thyroid function at high doses. May enhance sedative effects of medications.",
    scientificInfo:
      "Lemon balm inhibits GABA transaminase, increasing GABA availability. Also has mild antiviral activity against herpes simplex.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Chamomile",
    description:
      "Gentle, widely-used herb for relaxation, digestive comfort, and sleep support.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Apigenin",
      "Bisabolol",
    ...
    usage:
      "Commonly consumed as tea. Also available as extract or topical preparations.",
    dosage: "1-4 cups tea daily or 220-1100 mg extract",
    precautions:
      "May cause allergic reactions in those sensitive to ragweed family. May enhance effects of sedatives.",
    scientificInfo:
      "Apigenin in chamomile binds to GABA-A receptors and benzodiazepine receptors, producing calming effects.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Peppermint",
    description:
      "Refreshing herb with digestive-soothing and headache-relieving properties.",
    category: "Herbal",
    ...
    usage:
      "Tea, enteric-coated capsules for IBS, or topical oil for headaches.",
    dosage: "0.2-0.4 mL enteric-coated oil capsules three times daily for IBS",
    precautions:
      "May worsen GERD symptoms. Enteric coating essential for IBS use. Topical oil can cause skin irritation.",
    scientificInfo:
      "Menthol activates cold receptors and relaxes smooth muscle. Enteric-coated oil reduces intestinal spasms in IBS.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Feverfew",
    description:
      "Traditional herb used for migraine prevention and headache relief.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Parthenolide",
    ...
    precautions:
      "Do not use during pregnancy. May cause mouth ulcers with fresh leaf use. Gradual discontinuation recommended.",
    scientificInfo:
      "Parthenolide inhibits serotonin release from platelets and inflammatory mediators, potentially preventing migraine triggers.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "European herb with strong evidence for migraine prevention and seasonal allergy relief.",
    category: "Herbal",
    ...
    usage:
      "Use only PA-free (pyrrolizidine alkaloid-free) standardized extracts.",
    dosage: "50-75 mg PA-free extract twice daily",
    precautions:
      "ONLY use PA-free products; pyrrolizidine alkaloids are hepatotoxic. Avoid during pregnancy.",
    scientificInfo:
      "Petasin and isopetasin inhibit leukotriene synthesis and have spasmolytic effects on smooth muscle.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Black Cohosh",
    description:
      "Native American herb traditionally used for menopausal symptoms and womens health.",
    category: "Herbal",
    ingredients: JSON.stringify([
    ...
    precautions:
      "Rare liver toxicity reported; discontinue if signs of liver problems. Avoid with hormone-sensitive conditions.",
    scientificInfo:
      "Mechanism not fully understood but does not appear to have significant estrogenic activity. May affect serotonin receptors.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Hawthorn Berry",
    description:
      "Traditional heart tonic herb supporting cardiovascular function and blood pressure.",
    category: "Herbal",
    ingredients: JSON.stringify([
    ...
    precautions:
      "May enhance effects of heart medications. Consult cardiologist if on cardiac drugs.",
    scientificInfo:
      "Hawthorn increases coronary blood flow, has positive inotropic effects, and provides antioxidant protection to cardiovascular tissue.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Pungent culinary herb with cardiovascular, immune, and antimicrobial benefits.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Allicin",
      "S-allyl cysteine",
    ...
    usage:
      "Fresh garlic, aged garlic extract, or odorless capsules. Crushing activates allicin.",
    dosage: "600-1200 mg aged garlic extract daily or 4 g fresh garlic",
    precautions:
      "May increase bleeding risk. Discontinue before surgery. May interact with HIV medications.",
    scientificInfo:
      "Allicin and its derivatives inhibit cholesterol synthesis, relax blood vessels, and have broad antimicrobial activity.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Sacred adaptogenic herb from Ayurveda supporting stress resilience and overall vitality.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Eugenol",
      "Ursolic acid",
    ...
    precautions:
      "May affect blood clotting. May lower blood sugar. Avoid before surgery.",
    scientificInfo:
      "Tulsi modulates cortisol, has anti-inflammatory effects, and supports healthy blood glucose metabolism.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Resin extract with powerful anti-inflammatory properties, especially for joint health.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Boswellic acids",
      "AKBA",
    ...
    precautions:
      "Generally well tolerated. May cause GI upset in some individuals.",
    scientificInfo:
      "Boswellic acids inhibit 5-lipoxygenase, reducing inflammatory leukotrienes. AKBA is the most potent fraction.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Devils Claw",
    description:
      "African herb traditionally used for joint pain, back pain, and inflammation.",
    category: "Herbal",
    ...
    precautions:
      "Avoid with peptic ulcers. May affect heart rate and blood pressure medications.",
    scientificInfo:
      "Harpagoside inhibits COX-2 and iNOS expression, reducing inflammatory mediator production.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    precautions:
      "Avoid if allergic to aspirin. Not for children due to Reye syndrome risk. May increase bleeding.",
    scientificInfo:
      "Salicin is converted to salicylic acid in the body, inhibiting prostaglandin synthesis. Gentler on stomach than aspirin.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Pacific Island herb with potent anxiolytic effects, traditionally used for relaxation.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Kavalactones",
      "Kavain",
    ...
    usage:
      "Take in evening. Use water-extracted products from noble kava varieties.",
    dosage: "120-240 mg kavalactones daily",
    precautions:
      "Potential liver toxicity with long-term use or poor quality products. Avoid with alcohol. Not for those with liver disease.",
    scientificInfo:
      "Kavalactones modulate GABA-A receptors, voltage-gated sodium and calcium channels, and monoamine uptake.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Mediterranean herb rich in oleuropein with antimicrobial and cardiovascular benefits.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Oleuropein",
      "Hydroxytyrosol",
    ...
    precautions:
      "May enhance effects of blood pressure medications. May cause die-off reactions initially.",
    scientificInfo:
      "Oleuropein has broad antimicrobial activity and inhibits ACE, contributing to blood pressure reduction.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Versatile herb used for allergies, prostate health, and joint support.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Lectins",
      "Lignans",
    ...
    dosage:
      "300-600 mg leaf extract for allergies; 120-360 mg root extract for prostate",
    precautions:
      "May affect blood sugar and blood pressure. May interact with diabetes and blood pressure medications.",
    scientificInfo:
      "Nettle leaf inhibits inflammatory cytokines and histamine release. Root extract affects hormone binding and prostate cell proliferation.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Dandelion Root",
    description:
      "Common weed with powerful digestive and liver-supporting properties.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Inulin",
      "Taraxacin",
    ...
    usage:
      "Root for liver support; leaf for diuretic effect. Can be taken as tea, tincture, or capsules.",
    dosage: "2-8 g dried root daily or 250-500 mg extract",
    precautions:
      "May interact with diabetes medications and diuretics. Avoid with bile duct obstruction.",
    scientificInfo:
      "Dandelion stimulates bile production and flow. Inulin content supports beneficial gut bacteria.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Mediterranean herb supporting liver function, digestion, and healthy cholesterol levels.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Cynarin",
      "Chlorogenic acid",
    ...
    precautions:
      "Avoid with bile duct obstruction or gallstones. May cause allergic reactions in those sensitive to Asteraceae family.",
    scientificInfo:
      "Cynarin stimulates bile production. Chlorogenic acid and other compounds have hepatoprotective and lipid-lowering effects.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Precious spice with mood-supporting properties and antioxidant benefits.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Crocin",
      "Safranal",
    ...
    precautions:
      "Expensive; ensure quality sourcing. High doses may be toxic. Avoid during pregnancy.",
    scientificInfo:
      "Saffron constituents modulate serotonin reuptake and have antioxidant effects. Comparable to some antidepressants in trials.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Sweet root with adrenal support, digestive, and respiratory benefits.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Glycyrrhizin",
      "Glabridin",
    ...
    usage:
      "Use DGL (deglycyrrhizinated) form for digestive support to avoid blood pressure effects.",
    dosage: "250-500 mg DGL before meals; whole root short-term only",
    precautions:
      "Glycyrrhizin can raise blood pressure and lower potassium. Use DGL form for long-term use. Avoid with hypertension.",
    scientificInfo:
      "Glycyrrhizin inhibits cortisol breakdown, extending its action. DGL retains digestive benefits without affecting blood pressure.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Slippery Elm",
    description:
      "Soothing demulcent herb for digestive and respiratory tract irritation.",
    category: "Herbal",
    ...
    precautions:
      "May slow absorption of medications. Take separately from other supplements and medications.",
    scientificInfo:
      "Mucilage forms a protective coating over mucous membranes, reducing irritation and promoting healing.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Mucilaginous herb soothing to digestive and respiratory mucous membranes.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Mucilage",
      "Pectin",
    ...
    usage:
      "Cold infusion extracts more mucilage. Also available as capsules or syrup.",
    dosage: "2-5 g dried root daily or 300-500 mg extract",
    precautions:
      "May delay absorption of medications. Take separately from other supplements.",
    scientificInfo:
      "Mucilage content provides a protective film over irritated tissues, supporting natural healing.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Berberine",
    description:
      "Powerful plant alkaloid with metabolic, cardiovascular, and antimicrobial benefits.",
    category: "Herbal",
    ...
    precautions:
      "May interact with many medications including metformin, antibiotics. May cause GI upset initially.",
    scientificInfo:
      "Berberine activates AMPK, improving glucose and lipid metabolism. Comparable to metformin in some studies.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Aromatic spice supporting healthy blood sugar and metabolic function.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Cinnamaldehyde",
      "Proanthocyanidins",
    ...
    usage:
      "Use Ceylon cinnamon (true cinnamon) to avoid coumarin content of cassia cinnamon.",
    dosage: "1-6 g daily or 120-500 mg extract",
    precautions:
      "Cassia cinnamon contains coumarin which can affect liver at high doses. Choose Ceylon variety.",
    scientificInfo:
      "Cinnamon improves insulin receptor sensitivity and inhibits digestive enzymes, moderating glucose absorption.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Fenugreek",
    description:
      "Seed with benefits for blood sugar, testosterone, and lactation support.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "4-hydroxyisoleucine",
      "Saponins",
    ...
    precautions:
      "May cause maple syrup odor in urine and sweat. May affect blood sugar medications.",
    scientificInfo:
      "4-hydroxyisoleucine stimulates insulin secretion. Galactomannan fiber slows carbohydrate absorption.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Ayurvedic herb known as sugar destroyer for its ability to reduce sugar cravings and support blood sugar.",
    category: "Herbal",
    ...
    precautions:
      "May significantly affect blood sugar. Monitor closely if diabetic. May interact with diabetes medications.",
    scientificInfo:
      "Gymnemic acids block sugar receptors on taste buds and intestinal glucose absorption. May support beta cell regeneration.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Tropical fruit with potent blood sugar-lowering properties used in traditional medicine.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Charantin",
      "Vicine",
    ...
    precautions:
      "May cause hypoglycemia especially with diabetes medications. Not for use during pregnancy.",
    scientificInfo:
      "Contains insulin-like compounds and activates AMPK. Multiple mechanisms contribute to glucose-lowering effects.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Hibiscus",
    description:
      "Colorful flower tea with blood pressure and antioxidant benefits.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Anthocyanins",
      "Organic acids",
    ...
    dosage:
      "1.5-3 g dried flowers as tea 1-3 times daily or 250-500 mg extract",
    precautions:
      "May lower blood pressure. May interact with blood pressure and diabetes medications.",
    scientificInfo:
      "Anthocyanins have ACE-inhibitory activity. Studies show significant blood pressure reduction comparable to some medications.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Triphala",
    description:
      "Classic Ayurvedic formula of three fruits for digestive health and detoxification.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Amalaki",
      "Bibhitaki",
    ...
    usage:
      "Take before bed for bowel regularity or between meals for other benefits.",
    dosage: "500-1000 mg twice daily",
    precautions:
      "May cause loose stools initially. Start with lower dose. Not for use during pregnancy.",
    scientificInfo:
      "Triphala has prebiotic effects, promotes healthy gut flora, and has gentle laxative action from tannins and anthraquinones.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Andrographis",
    description:
      "Bitter herb known as King of Bitters with immune-modulating and cold-fighting properties.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Andrographolide",
      "Neoandrographolide",
    ...
    dosage:
      "400 mg three times daily standardized to andrographolides during acute illness",
    precautions:
      "May affect fertility. Not for use during pregnancy or when trying to conceive. May interact with immunosuppressants.",
    scientificInfo:
      "Andrographolide inhibits NF-kB and has antiviral activity. Clinical trials show reduced cold severity and duration.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Premier Qi-tonifying herb in Traditional Chinese Medicine for immune and vitality support.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "Astragalosides",
      "Polysaccharides",
    ...
    usage:
      "Can be taken long-term for immune support. Traditionally simmered in soups.",
    dosage:
      "250-500 mg extract two to three times daily or 9-30 g dried root in decoction",
    precautions:
      "May interact with immunosuppressants. Use caution in autoimmune conditions.",
    scientificInfo:
      "Astragalosides stimulate immune cell activity and have cardioprotective effects. May support telomere length.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Oregano Oil",
    description:
      "Potent antimicrobial essential oil with broad-spectrum activity against pathogens.",
    category: "Herbal",
    ...
    usage:
      "Use enteric-coated capsules or dilute in carrier oil. Not for topical use undiluted.",
    dosage: "50-200 mg carvacrol in enteric-coated form daily short-term",
    precautions:
      "Very potent; can irritate mucous membranes. Not for long-term use. May affect iron absorption.",
    scientificInfo:
      "Carvacrol and thymol disrupt bacterial cell membranes. Effective against many bacteria, fungi, and parasites.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Lavender",
    description:
      "Calming aromatic herb supporting relaxation, sleep, and mood balance.",
    category: "Herbal",
    ...
    usage:
      "Inhaled as aromatherapy, taken orally as Silexan capsules, or used topically diluted.",
    dosage:
      "80-160 mg Silexan (standardized oral lavender) daily or aromatherapy as needed",
    precautions:
      "Oral lavender may cause GI upset. May enhance effects of sedatives.",
    scientificInfo:
      "Linalool modulates GABA receptors and serotonin transporters. Silexan has shown efficacy comparable to benzodiazepines.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Maca Root",
    description:
      "Peruvian adaptogen supporting energy, libido, and hormone balance.",
    category: "Herbal",
    ...
    precautions:
      "May affect hormone levels. Those with hormone-sensitive conditions should use caution.",
    scientificInfo:
      "Maca does not contain hormones but may support hypothalamic-pituitary function and hormone balance.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Traditional herb used for libido, athletic performance, and vitality.",
    category: "Herbal",
    ...
    precautions:
      "Limited evidence for testosterone boosting claims. May interact with diabetes and blood pressure medications.",
    scientificInfo:
      "May support nitric oxide production and androgen receptor sensitivity rather than directly increasing testosterone.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Concentrated polyphenols from green tea with metabolic and antioxidant benefits.",
    category: "Herbal",
    ingredients: JSON.stringify([
      "EGCG",
      "Catechins",
    ...
    usage:
      "Take with food to reduce potential liver stress. Decaffeinated versions available.",
    dosage: "250-500 mg EGCG daily",
    precautions:
      "High doses on empty stomach may affect liver. Limit to reasonable doses. Contains caffeine unless decaffeinated.",
    scientificInfo:
      "EGCG enhances thermogenesis, inhibits catechol-O-methyltransferase, and has broad antioxidant activity.",
    references: JSON.stringify([

...
export const additionalRemedies = [
  // More TCM and Ayurvedic Herbs
  {
    ...
    description: 'TCM longevity herb for vitality, hair health, and healthy aging.',
    category: 'Herbal',
    ingredients: JSON.stringify(['Stilbene glycosides', 'Emodin', 'Catechins']),
    benefits: JSON.stringify(['Longevity support', 'Hair health', 'Vitality', 'Liver and kidney tonic']),
    usage: 'Use prepared (processed) form only. Raw form can cause GI upset.',
    dosage: '500-1000 mg prepared extract daily',
    precautions: 'Use only prepared form. Raw form hepatotoxic. Rare liver concerns even with prepared form.',
    scientificInfo: 'Prepared Fo-Ti has antioxidant and potential longevity benefits through multiple mechanisms.',
  ...
  },
  {
    ...
    category: 'Herbal',
    ingredients: JSON.stringify(['Lycium barbarum polysaccharides', 'Zeaxanthin', 'Beta-carotene']),
    benefits: JSON.stringify(['Eye health', 'Immune support', 'Antioxidant', 'Energy', 'Longevity']),
    ...
    scientificInfo: 'Rich in zeaxanthin for macular health and unique polysaccharides with immunomodulating effects.',
    references: JSON.stringify([
  ...
  },
  {
    ...
    description: 'Vitamin C-rich Ayurvedic fruit for immunity and rejuvenation.',
    category: 'Herbal',
    ingredients: JSON.stringify(['Vitamin C', 'Tannins', 'Gallic acid', 'Ellagic acid']),
    benefits: JSON.stringify(['Immune support', 'Hair health', 'Digestive support', 'Antioxidant', 'Blood sugar support']),
    ...
    scientificInfo: 'Amla has exceptionally high and stable vitamin C content with synergistic tannins.',
    references: JSON.stringify([
  ...
  },
  {
    ...
    category: 'Herbal',
    ingredients: JSON.stringify(['Tinosporin', 'Cordifolioside', 'Berberine', 'Polysaccharides']),
    benefits: JSON.stringify(['Immune modulation', 'Fever support', 'Digestive support', 'Liver protection']),
    usage: 'Use as extract or traditional preparation.',
    dosage: '300-500 mg extract twice daily',
    precautions: 'May lower blood sugar. Use caution with diabetes medications.',
    scientificInfo: 'Guduchi has immunomodulating effects and supports both innate and adaptive immunity.',
    references: JSON.stringify([
      'Saha S, Ghosh S. Tinospora cordifolia: One plant, many roles. Anc Sci Life. 2012;31(4):151-159.'
    ]),
    relatedRemedies: JSON.stringify(['Astragalus', 'Andrographis', 'Holy Basil']),
    evidenceLevel: 'Limited'
  },
  {
    name: 'Shatavari',
    ...
    category: 'Herbal',
    ingredients: JSON.stringify(['Steroidal saponins', 'Shatavarins', 'Isoflavones']),
    benefits: JSON.stringify(['Womens health', 'Lactation support', 'Hormonal balance', 'Digestive soothing']),
    ...
    scientificInfo: 'Shatavari has adaptogenic and phytoestrogenic effects supporting female reproductive health.',
    references: JSON.stringify([
  ...
  },
  {
    ...
    benefits: JSON.stringify(['Hair growth', 'Hair pigmentation', 'Liver support', 'Skin health']),
    ...
    scientificInfo: 'Wedelolactone has hepatoprotective effects and traditional use for hair health.',
    references: JSON.stringify([
  ...
  // Superfoods and functional foods
  {
    ...
    category: 'Superfood',
    ingredients: JSON.stringify(['Phycocyanin', 'Chlorophyll', 'Complete protein', 'Iron', 'B vitamins']),
    benefits: JSON.stringify(['Nutritional support', 'Energy', 'Detoxification', 'Immune support', 'Antioxidant']),
    usage: 'Use powder or tablets. Start with small amount.',
    dosage: '1-10 g daily',
    precautions: 'Choose tested products free of contamination. May interact with immunosuppressants.',
    scientificInfo: 'Spirulina is 60-70% complete protein with phycocyanin providing unique antioxidant effects.',
    references: JSON.stringify([
    ...
    relatedRemedies: JSON.stringify(['Chlorella', 'Wheatgrass', 'Barley Grass']),
    evidenceLevel: 'Moderate'
  },
  {
    name: 'Chlorella',
    ...
    category: 'Superfood',
    ingredients: JSON.stringify(['Chlorella growth factor', 'Chlorophyll', 'Protein', 'Iron', 'B12']),
    benefits: JSON.stringify(['Detoxification', 'Heavy metal binding', 'Immune support', 'Nutritional support']),
    ...
    scientificInfo: 'Chlorella binds heavy metals and provides growth factor that may support cellular repair.',
    references: JSON.stringify([
    ...
    relatedRemedies: JSON.stringify(['Spirulina', 'Cilantro', 'Activated Charcoal']),
    evidenceLevel: 'Limited'
  },
  {
    name: 'Wheatgrass',
    ...
    category: 'Superfood',
    ingredients: JSON.stringify(['Chlorophyll', 'Enzymes', 'Amino acids', 'Vitamins']),
    benefits: JSON.stringify(['Detoxification', 'Alkalizing', 'Energy', 'Digestive support']),
    usage: 'Fresh juice or freeze-dried powder.',
    dosage: '30-60 mL fresh juice or 3-5 g powder daily',
    precautions: 'Start slowly. May cause nausea in some. Gluten-free as harvested before seed develops.',
    scientificInfo: 'Chlorophyll has structural similarity to hemoglobin and traditional use for blood building.',
    references: JSON.stringify([
      'Bar-Sela G, et al. Wheat grass juice in the supportive care of cancer patients. Nutr Cancer. 2007;58(1):43-48.'
    ]),
    relatedRemedies: JSON.stringify(['Barley Grass', 'Spirulina', 'Chlorophyll']),
    evidenceLevel: 'Limited'
  },
  {
    name: 'Barley Grass',
    ...
    category: 'Superfood',
    ingredients: JSON.stringify(['Superoxide dismutase', 'Chlorophyll', 'Beta-glucan', 'Vitamins']),
    benefits: JSON.stringify(['Antioxidant', 'Alkalizing', 'Cholesterol support', 'Energy']),
    usage: 'Use juice or powder.',
    dosage: '3-5 g powder daily',
    precautions: 'Gluten-free as harvested before grain develops.',
    scientificInfo: 'Contains superoxide dismutase (SOD) and other antioxidants.',
    references: JSON.stringify([
  ...
  {
    name: 'Bee Pollen',
    description: 'Nutrient-dense pollen collected by bees for energy and immunity.',
    category: 'Superfood',
    ingredients: JSON.stringify(['Protein', 'Vitamins', 'Minerals', 'Enzymes', 'Flavonoids']),
    benefits: JSON.stringify(['Energy', 'Immune support', 'Allergy relief', 'Athletic performance']),
    usage: 'Start with small amount to test for allergy.',
    dosage: '1-2 teaspoons daily, working up gradually',
    precautions: 'May cause severe allergic reactions in bee-allergic individuals. Start with tiny amount.',
    scientificInfo: 'Bee pollen is approximately 25% protein with all essential amino acids and rich in enzymes.',
    references: JSON.stringify([
    ...
    relatedRemedies: JSON.stringify(['Royal Jelly', 'Propolis', 'Manuka Honey']),
    evidenceLevel: 'Limited'
  },
  {
    name: 'Royal Jelly',
    ...
    category: 'Superfood',
    ingredients: JSON.stringify(['10-HDA', 'Royalactin', 'Proteins', 'B vitamins']),
    benefits: JSON.stringify(['Energy', 'Skin health', 'Fertility support', 'Cognitive function']),
    usage: 'Keep refrigerated. Take fresh or lyophilized.',
    dosage: '500-3000 mg daily',
    precautions: 'Potential for severe allergic reactions. Avoid with bee allergies.',
    scientificInfo: '10-HDA is a unique fatty acid with potential metabolic and longevity effects.',
    references: JSON.stringify([
  ...
  {
    name: 'Propolis',
    description: 'Bee resin with antimicrobial and immune-supporting properties.',
    category: 'Superfood',
    ingredients: JSON.stringify(['CAPE', 'Flavonoids', 'Phenolic acids', 'Resins']),
    benefits: JSON.stringify(['Immune support', 'Antimicrobial', 'Wound healing', 'Oral health']),
    ...
    scientificInfo: 'CAPE (caffeic acid phenethyl ester) has potent anti-inflammatory and antimicrobial effects.',
    references: JSON.stringify([
      'Wagh VD. Propolis: a wonder bees product and its pharmacological potentials. Adv Pharmacol Sci. 2013;2013:308249.'
    ]),
    relatedRemedies: JSON.stringify(['Manuka Honey', 'Bee Pollen', 'Echinacea']),
    evidenceLevel: 'Moderate'
  },
  {
    name: 'Cacao (Raw)',
    description: 'Unprocessed cocoa for mood, cardiovascular health, and antioxidants.',
    category: 'Superfood',
    ingredients: JSON.stringify(['Theobromine', 'Flavanols', 'Magnesium', 'Anandamide', 'PEA']),
    benefits: JSON.stringify(['Mood enhancement', 'Cardiovascular support', 'Antioxidant', 'Energy']),
    ...
    scientificInfo: 'Raw cacao retains more flavanols than processed chocolate and contains mood-enhancing compounds.',
    references: JSON.stringify([
      'Katz DL, et al. Cocoa and chocolate in human health and disease. Antioxid Redox Signal. 2011;15(10):2779-2811.'
    ]),
    relatedRemedies: JSON.stringify(['Dark Chocolate', 'Magnesium', 'Green Tea']),
    evidenceLevel: 'Moderate'
  },
  {
    name: 'Acai Berry',
    ...
    category: 'Superfood',
    ingredients: JSON.stringify(['Anthocyanins', 'Proanthocyanidins', 'Healthy fats', 'Fiber']),
    benefits: JSON.stringify(['Antioxidant', 'Cardiovascular support', 'Skin health', 'Energy']),
    ...
    scientificInfo: 'Acai has one of the highest ORAC values among fruits due to anthocyanin content.',
    references: JSON.stringify([
    ...
    relatedRemedies: JSON.stringify(['Blueberries', 'Goji Berry', 'Resveratrol']),
    evidenceLevel: 'Limited'
  },
  {
    name: 'Pomegranate',
    description: 'Antioxidant-rich fruit for cardiovascular and prostate health.',
    category: 'Food',
    ingredients: JSON.stringify(['Punicalagins', 'Ellagic acid', 'Anthocyanins', 'Punicic acid']),
    benefits: JSON.stringify(['Cardiovascular health', 'Prostate health', 'Antioxidant', 'Blood pressure support']),
    ...
    scientificInfo: 'Punicalagins are potent antioxidants with cardiovascular and anti-inflammatory benefits.',
    references: JSON.stringify([
    ...
    relatedRemedies: JSON.stringify(['Resveratrol', 'Grape Seed Extract', 'Green Tea']),
    evidenceLevel: 'Moderate'
  },
  {
    name: 'Grape Seed Extract',
    description: 'Concentrated proanthocyanidins for vascular health and antioxidant support.',
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Proanthocyanidins', 'OPCs', 'Resveratrol']),
    benefits: JSON.stringify(['Vascular health', 'Antioxidant', 'Skin health', 'Blood pressure support']),
    usage: 'Take with or without food.',
    dosage: '100-300 mg standardized extract daily',
    precautions: 'May enhance blood thinners.',
    scientificInfo: 'OPCs strengthen capillaries and have potent antioxidant effects 20x stronger than vitamin C.',
    references: JSON.stringify([
  ...
  },
  {
    ...
    description: 'French maritime pine bark extract for circulation and antioxidant support.',
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Procyanidins', 'OPCs', 'Bioflavonoids']),
    benefits: JSON.stringify(['Circulation', 'Skin health', 'ADHD support', 'Chronic venous insufficiency', 'Antioxidant']),
    usage: 'Take with or without food.',
    dosage: '50-200 mg daily',
    precautions: 'May enhance effects of blood thinners.',
    scientificInfo: 'Pycnogenol improves endothelial function and has extensive clinical research.',
    references: JSON.stringify([
      'Rohdewald P. A review of the French maritime pine bark extract (Pycnogenol). Int J Clin Pharmacol Ther. 2002;40(4):158-168.'
    ]),
    relatedRemedies: JSON.stringify(['Grape Seed Extract', 'Hawthorn', 'Vitamin C']),
  ...
  // More specialized supplements
  {
    ...
    benefits: JSON.stringify(['Muscle preservation', 'Strength gains', 'Recovery', 'Sarcopenia prevention']),
    ...
    scientificInfo: 'HMB reduces protein breakdown and may enhance mTOR signaling for muscle protein synthesis.',
    references: JSON.stringify([
  ...
  {
    name: 'Ornithine',
    description: 'Amino acid supporting ammonia detoxification and growth hormone.',
    category: 'Amino Acid',
    ingredients: JSON.stringify(['L-Ornithine', 'Ornithine alpha-ketoglutarate']),
    benefits: JSON.stringify(['Ammonia detoxification', 'Sleep quality', 'Exercise recovery', 'Growth hormone support']),
    usage: 'Take before bed or after exercise.',
    dosage: '2-6 g daily',
    precautions: 'Generally safe. May cause GI upset at high doses.',
    scientificInfo: 'Ornithine is part of the urea cycle and may reduce fatigue by removing ammonia.',
    references: JSON.stringify([
  ...
  },
  {
    ...
    benefits: JSON.stringify(['Liver support', 'Brain function', 'Cell membrane integrity', 'Fat metabolism']),
    usage: 'Take with meals.',
    dosage: '1-3 g daily',
    precautions: 'May cause fishy odor. Generally safe.',
    scientificInfo: 'Phosphatidylcholine is the predominant phospholipid in cell membranes and bile.',
    references: JSON.stringify([
  ...
  {
    name: 'Inositol',
    description: 'B-vitamin-like compound for mood, PCOS, and metabolic health.',
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Myo-inositol', 'D-chiro-inositol']),
    benefits: JSON.stringify(['Anxiety relief', 'PCOS support', 'Insulin sensitivity', 'Mood balance']),
    usage: 'Myo-inositol most common. D-chiro-inositol specifically for insulin.',
    dosage: '2-18 g myo-inositol daily depending on use',
    precautions: 'May cause GI upset at high doses. Start low.',
    scientificInfo: 'Inositol is a second messenger in insulin and neurotransmitter signaling.',
    references: JSON.stringify([
  ...
  },
  {
    ...
    benefits: JSON.stringify(['Estrogen metabolism', 'Hormone balance', 'Prostate health', 'Skin health']),
    usage: 'Take with food for absorption.',
    dosage: '100-300 mg daily',
    precautions: 'May affect hormone-sensitive conditions. Can cause harmless change in urine color.',
    scientificInfo: 'DIM promotes favorable estrogen metabolite ratios (2-hydroxy vs 16-alpha-hydroxy estrogens).',
    references: JSON.stringify([
    ...
    relatedRemedies: JSON.stringify(['I3C', 'Cruciferous Vegetables', 'Calcium D-Glucarate']),
    evidenceLevel: 'Moderate'
  },
  {
    ...
    benefits: JSON.stringify(['Detoxification support', 'Estrogen clearance', 'Cellular health']),
    usage: 'Take with meals.',
    dosage: '500-1500 mg daily',
    precautions: 'May enhance clearance of certain drugs.',
    scientificInfo: 'Inhibits beta-glucuronidase, preventing reabsorption of compounds being detoxified.',
    references: JSON.stringify([
  ...
  {
    name: 'Serrapeptase',
    description: 'Proteolytic enzyme with anti-inflammatory and fibrinolytic properties.',
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Serratiopeptidase', 'Serrapeptase']),
    benefits: JSON.stringify(['Anti-inflammatory', 'Sinus support', 'Fibrin breakdown', 'Pain relief']),
    ...
    scientificInfo: 'Serrapeptase breaks down inflammatory proteins and may thin mucus secretions.',
    references: JSON.stringify([
  ...
  {
    name: 'Nattokinase',
    description: 'Soy-derived enzyme supporting cardiovascular health and blood flow.',
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Nattokinase']),
    benefits: JSON.stringify(['Cardiovascular support', 'Blood flow', 'Fibrin breakdown', 'Blood pressure support']),
    usage: 'Take on empty stomach. Often taken at bedtime.',
    dosage: '2000-4000 FU daily',
    precautions: 'May enhance blood thinners. Discontinue before surgery. Not with bleeding disorders.',
    scientificInfo: 'Nattokinase has direct fibrinolytic activity and may support healthy blood viscosity.',
    references: JSON.stringify([
  ...
  // Eye health supplements
  {
    ...
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Lutein', 'Zeaxanthin', 'Meso-zeaxanthin', 'Zinc', 'Vitamin C', 'Vitamin E']),
    benefits: JSON.stringify(['Macular health', 'Blue light protection', 'Vision support']),
    usage: 'Take with fat-containing meal.',
    dosage: 'Follow AREDS2 formula guidelines',
    precautions: 'AREDS2 formula preferred over AREDS1 (no beta-carotene for smokers).',
    scientificInfo: 'Based on Age-Related Eye Disease Study showing reduced progression of macular degeneration.',
    references: JSON.stringify([
      'AREDS2 Research Group. Lutein + zeaxanthin and omega-3 fatty acids for AMD. JAMA. 2013;309(19):2005-2015.'
    ]),
    relatedRemedies: JSON.stringify(['Lutein and Zeaxanthin', 'Astaxanthin', 'Bilberry']),
    evidenceLevel: 'Strong'
  },
  {
    name: 'Vision Support (General)',
    description: 'Comprehensive eye health formula with multiple supportive nutrients.',
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Vitamin A', 'Bilberry', 'Lutein', 'Taurine', 'Zinc']),
    benefits: JSON.stringify(['General eye health', 'Night vision', 'Eye fatigue', 'Dry eye support']),
    usage: 'Take daily with food.',
    dosage: 'Follow product directions',
    precautions: 'Avoid high-dose vitamin A during pregnancy.',
    scientificInfo: 'Combination of antioxidants and nutrients that support various aspects of eye health.',
    references: JSON.stringify([
  ...
  // Sleep support
  {
    ...
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Melatonin', 'Valerian', 'Magnesium', 'L-Theanine', 'GABA', 'Chamomile']),
    benefits: JSON.stringify(['Sleep onset', 'Sleep quality', 'Relaxation', 'Stress reduction']),
    usage: 'Take 30-60 minutes before bed.',
    dosage: 'Follow product directions',
    precautions: 'May cause morning grogginess. Avoid driving after taking.',
    scientificInfo: 'Combines multiple evidence-based sleep-supporting ingredients for synergistic effect.',
    references: JSON.stringify([
  ...
  // Stress and adrenal support
  {
    ...
    description: 'Adaptogen and nutrient blend for stress resilience and adrenal health.',
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Ashwagandha', 'Rhodiola', 'Holy Basil', 'B vitamins', 'Vitamin C', 'Magnesium']),
    benefits: JSON.stringify(['Stress resilience', 'Energy', 'Adrenal support', 'Cortisol modulation']),
    usage: 'Take in morning and early afternoon. Avoid evening dosing.',
    dosage: 'Follow product directions',
    precautions: 'May affect thyroid. May be stimulating for some.',
    scientificInfo: 'Combines adaptogens and nutrients depleted by stress for comprehensive adrenal support.',
    references: JSON.stringify([
  ...
  // Liver support
  {
    ...
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Milk Thistle', 'NAC', 'Alpha-Lipoic Acid', 'Dandelion', 'Artichoke', 'Turmeric']),
    benefits: JSON.stringify(['Liver protection', 'Detoxification', 'Bile flow', 'Antioxidant support']),
    usage: 'Take with meals.',
    dosage: 'Follow product directions',
    precautions: 'May interact with medications metabolized by liver.',
    scientificInfo: 'Combines hepatoprotective herbs and nutrients for comprehensive liver support.',
    references: JSON.stringify([
  ...
  // Heart health
  {
    ...
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['CoQ10', 'Omega-3', 'Hawthorn', 'Magnesium', 'Vitamin K2', 'Garlic']),
    benefits: JSON.stringify(['Heart health', 'Blood pressure support', 'Cholesterol support', 'Circulation']),
    usage: 'Take with meals containing fat.',
    dosage: 'Follow product directions',
    precautions: 'May interact with blood thinners and blood pressure medications.',
    scientificInfo: 'Combines evidence-based cardiovascular nutrients for comprehensive heart support.',
    references: JSON.stringify([
  ...
  // Bone health
  {
    ...
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Calcium', 'Vitamin D3', 'Vitamin K2', 'Magnesium', 'Boron', 'Strontium']),
    benefits: JSON.stringify(['Bone density', 'Calcium absorption', 'Bone matrix', 'Fracture prevention']),
    usage: 'Divide calcium doses for absorption. Take with food.',
    dosage: 'Follow product directions',
    precautions: 'Strontium separate from calcium by 2 hours. K2 caution with blood thinners.',
    scientificInfo: 'Combines bone-building minerals with vitamins D3 and K2 for proper calcium utilization.',
    references: JSON.stringify([
  ...
  // Joint health
  {
    ...
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Glucosamine', 'Chondroitin', 'MSM', 'Hyaluronic Acid', 'Collagen', 'Turmeric']),
    benefits: JSON.stringify(['Joint comfort', 'Cartilage support', 'Joint lubrication', 'Flexibility']),
    usage: 'Take daily. Allow 4-8 weeks for benefits.',
    dosage: 'Follow product directions',
    precautions: 'Shellfish allergy caution with glucosamine. May affect blood sugar.',
    scientificInfo: 'Combines cartilage building blocks with anti-inflammatory support.',
    references: JSON.stringify([
  ...
  // Brain health
  {
    ...
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Lions Mane', 'Bacopa', 'Ginkgo', 'Phosphatidylserine', 'Omega-3 DHA', 'B vitamins']),
    benefits: JSON.stringify(['Memory', 'Focus', 'Cognitive function', 'Neuroprotection']),
    usage: 'Take with fat-containing meal for absorption.',
    dosage: 'Follow product directions',
    precautions: 'Ginkgo may interact with blood thinners. Allow 4-12 weeks for effects.',
  ...
  // Immune support
  {
    ...
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Vitamin C', 'Vitamin D3', 'Zinc', 'Elderberry', 'Echinacea', 'Astragalus']),
    benefits: JSON.stringify(['Immune function', 'Cold prevention', 'Respiratory health']),
    usage: 'Take daily for prevention or increase during illness.',
    dosage: 'Follow product directions',
    precautions: 'May interact with immunosuppressants.',
    scientificInfo: 'Combines immune-essential nutrients with traditional immune herbs.',
    references: JSON.stringify([
  ...
  // Mens health
  {
    ...
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Saw Palmetto', 'Pygeum', 'Nettle Root', 'Beta-Sitosterol', 'Zinc', 'Lycopene']),
    benefits: JSON.stringify(['Prostate health', 'Urinary flow', 'BPH support']),
    usage: 'Take daily with food.',
    dosage: 'Follow product directions',
    precautions: 'May affect PSA readings. Inform urologist.',
    scientificInfo: 'Combines evidence-based prostate-supporting herbs and nutrients.',
    references: JSON.stringify([
  ...
  // Womens health
  {
    ...
    category: 'Specialty Nutrient',
    ingredients: JSON.stringify(['Vitex', 'Dong Quai', 'Black Cohosh', 'Maca', 'Evening Primrose Oil', 'B6']),
    benefits: JSON.stringify(['Hormone balance', 'PMS relief', 'Menstrual regularity', 'Menopausal support']),
    usage: 'Take daily. Allow 2-3 months for effects.',
    dosage: 'Follow product directions',
    precautions: 'Avoid with hormone-sensitive conditions. Not during pregnancy.',

...
export const aminoAcidRemedies = [
  {
    name: "L-Theanine",
    description:
      "Calming amino acid from tea that promotes relaxation without drowsiness and enhances focus.",
    category: "Amino Acid",
    ...
    usage:
      "Can be taken any time. Often combined with caffeine for focused alertness.",
    ...
    scientificInfo:
      "L-theanine increases alpha brain waves, promoting relaxed alertness. It modulates GABA, dopamine, and serotonin.",
  ...
  },
  {
    name: "L-Tyrosine",
    description:
      "Precursor amino acid to dopamine, norepinephrine, and thyroid hormones supporting mental performance under stress.",
    category: "Amino Acid",
    ...
    usage:
      "Take on empty stomach for best absorption. Morning dosing preferred.",
    dosage: "500-2000 mg daily on empty stomach",
    precautions:
      "May interact with thyroid medications and MAOIs. Avoid with hyperthyroidism.",
    scientificInfo:
      "Tyrosine is the rate-limiting precursor for catecholamine synthesis. Supplementation supports performance during stress-induced catecholamine depletion.",
    references: JSON.stringify([
  ...
  },
  {
    name: "L-Tryptophan",
    description:
      "Essential amino acid precursor to serotonin and melatonin, supporting mood and sleep.",
    category: "Amino Acid",
    ...
    usage:
      "Take in evening for sleep, or with carbohydrates to enhance brain uptake.",
    dosage: "500-2000 mg daily; 500-1000 mg before bed for sleep",
    precautions:
      "Do not combine with SSRIs or MAOIs due to serotonin syndrome risk. Start with lower doses.",
    scientificInfo:
      "Tryptophan is converted to 5-HTP, then to serotonin, and finally to melatonin. It competes with other amino acids for brain transport.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Direct serotonin precursor for mood, sleep, and appetite support.",
    category: "Amino Acid",
    ...
    precautions:
      "Do NOT combine with SSRIs, SNRIs, or MAOIs - risk of serotonin syndrome. Start low.",
    scientificInfo:
      "5-HTP crosses the blood-brain barrier and is directly converted to serotonin. Bypasses rate-limiting tryptophan hydroxylase step.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Inhibitory neurotransmitter supplement for relaxation and calm.",
    category: "Amino Acid",
    ...
    precautions:
      "Debate exists about blood-brain barrier crossing. May cause tingling sensation.",
    scientificInfo:
      "Oral GABA may act on peripheral GABA receptors and enteric nervous system. Some evidence suggests limited BBB crossing.",
    references: JSON.stringify([
  ...
  },
  {
    name: "L-Glutamine",
    description:
      "Most abundant amino acid in the body, essential for gut health, immune function, and muscle recovery.",
    category: "Amino Acid",
    ...
    usage:
      "Take on empty stomach or post-workout. Powder dissolves easily in water.",
    dosage: "5-15 g daily; higher doses for gut healing",
    precautions:
      "Generally safe. Those with kidney or liver disease should consult healthcare provider.",
    scientificInfo:
      "Glutamine is primary fuel for enterocytes and immune cells. Critical for maintaining intestinal barrier integrity.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Precursor to glutathione with powerful antioxidant, detoxification, and respiratory support.",
    category: "Amino Acid",
    ...
    usage:
      "Take with food to reduce GI effects. Can be taken away from other antioxidants.",
    dosage: "600-1800 mg daily in divided doses",
    precautions:
      "May interact with nitroglycerin. Use caution with bleeding disorders.",
    scientificInfo:
      "NAC provides cysteine for glutathione synthesis and has direct antioxidant effects. Used medically for acetaminophen overdose.",
    references: JSON.stringify([
  ...
  },
  {
    name: "L-Carnitine",
    description:
      "Amino acid derivative transporting fatty acids into mitochondria for energy production.",
    category: "Amino Acid",
    ...
    precautions:
      "May cause fishy body odor at high doses. TMAO concerns debated.",
    scientificInfo:
      "Carnitine shuttles long-chain fatty acids into mitochondria. ALCAR crosses blood-brain barrier for neurological support.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Brain-penetrating form of carnitine supporting cognitive function and nerve health.",
    category: "Amino Acid",
    ...
    scientificInfo:
      "ALCAR provides acetyl groups for acetylcholine synthesis and supports mitochondrial function in neurons.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Glycine",
    description:
      "Simple amino acid with calming effects, supporting sleep and collagen production.",
    category: "Amino Acid",
    ...
    precautions:
      "Generally very safe. May enhance effects of antipsychotic medications.",
    scientificInfo:
      "Glycine acts as an inhibitory neurotransmitter and reduces core body temperature, promoting sleep. Essential for glutathione synthesis.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Taurine",
    description:
      "Amino acid supporting heart health, eye health, and nervous system function.",
    category: "Amino Acid",
    ...
    precautions:
      "Generally very safe. May potentiate effects of some medications.",
    scientificInfo:
      "Taurine modulates calcium signaling, has membrane-stabilizing effects, and acts as an antioxidant. Highest concentrations in heart and retina.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Essential amino acids (leucine, isoleucine, valine) supporting muscle protein synthesis and recovery.",
    category: "Amino Acid",
    ...
    usage:
      "Take before, during, or after exercise. Typical ratio is 2:1:1 leucine:isoleucine:valine.",
    dosage: "5-10 g daily around exercise",
    precautions:
      "Those with maple syrup urine disease should avoid. May affect blood sugar.",
    scientificInfo:
      "BCAAs are metabolized directly in muscle tissue. Leucine is the primary trigger for mTOR-mediated protein synthesis.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Naturally occurring compound supporting energy production, strength, and cognitive function.",
    category: "Amino Acid",
    ...
    usage:
      "Take daily consistently. Loading phase optional. Mix with water or juice.",
    dosage:
      "3-5 g daily; or 20 g daily for 5-7 days loading then 3-5 g maintenance",
    precautions:
      "Stay well hydrated. Generally very safe with extensive research.",
    scientificInfo:
      "Creatine phosphate regenerates ATP during high-intensity exercise. Brain also uses creatine for energy.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Beta-Alanine",
    description:
      "Amino acid increasing muscle carnosine for improved exercise capacity and reduced fatigue.",
    category: "Amino Acid",
    ...
    usage:
      "Take daily split into multiple doses to reduce tingling. Sustained-release forms available.",
    dosage: "3.2-6.4 g daily in divided doses",
    precautions:
      "Causes harmless tingling (paresthesia) that subsides with continued use.",
    scientificInfo:
      "Beta-alanine is the rate-limiting precursor to carnosine, which buffers hydrogen ions in muscle during high-intensity exercise.",
    references: JSON.stringify([
  ...
  },
  {
    name: "L-Citrulline",
    description:
      "Amino acid supporting nitric oxide production for circulation and exercise performance.",
    category: "Amino Acid",
    ...
    usage:
      "Take 30-60 minutes before exercise. Citrulline malate form provides additional malic acid.",
    dosage: "3-6 g L-citrulline or 6-8 g citrulline malate before exercise",
    precautions:
      "Generally safe. May enhance effects of blood pressure medications.",
    scientificInfo:
      "Citrulline is converted to arginine in kidneys, providing sustained nitric oxide production. More effective than direct arginine supplementation.",
    references: JSON.stringify([
  ...
  },
  {
    name: "L-Arginine",
    description:
      "Semi-essential amino acid precursor to nitric oxide for cardiovascular and immune function.",
    category: "Amino Acid",
    ...
    usage:
      "Take on empty stomach. L-citrulline may be more effective for nitric oxide.",
    dosage: "3-6 g daily in divided doses",
    precautions:
      "May interact with blood pressure medications and Viagra. Avoid after heart attack. May activate herpes outbreaks.",
    scientificInfo:
      "Arginine is the substrate for nitric oxide synthase. However, first-pass metabolism limits effectiveness compared to citrulline.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Hydrolyzed protein supporting skin, joint, bone, and gut health.",
    category: "Amino Acid",
    ingredients: JSON.stringify([
      "Hydrolyzed collagen",
      "Collagen peptides",
    ...
    usage:
      "Mix in hot or cold beverages. Type I/III for skin; Type II for joints.",
    dosage: "10-15 g daily",
    precautions:
      "Generally very safe. Source quality matters (grass-fed, marine).",
    scientificInfo:
      "Collagen peptides are absorbed and distributed to connective tissues. May stimulate fibroblast collagen production.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Whey Protein",
    description:
      "Complete protein from milk supporting muscle synthesis, immune function, and satiety.",
    category: "Amino Acid",
    ingredients: JSON.stringify([
    ...
    usage:
      "Post-workout or as meal replacement. Isolate form for lactose sensitivity.",
    dosage:
      "20-40 g per serving; total protein needs vary by body weight and activity",
    precautions:
      "Dairy allergy or lactose intolerance may limit use. Choose quality sources.",
    scientificInfo:
      "Whey is rapidly absorbed and rich in leucine, maximally stimulating muscle protein synthesis. Contains immunoglobulins and lactoferrin.",
    references: JSON.stringify([
  ...
  },
  {
    ...
    description:
      "Natural compound involved in methylation, supporting mood, liver function, and joint health.",
    category: "Amino Acid",
    ...
    usage:
      "Take on empty stomach for mood benefits. Enteric-coated forms preferred.",
    dosage: "400-1600 mg daily for mood; 600-1200 mg for joints",
    precautions:
      "Do not combine with SSRIs or MAOIs. May trigger mania in bipolar disorder. Start with low doses.",
    scientificInfo:
      "SAMe is a methyl donor involved in neurotransmitter synthesis, cartilage formation, and liver metabolism. Comparable to antidepressants in trials.",
    references: JSON.stringify([
  ...
  },
  {
    name: "Betaine (TMG)",
    description:
      "Methyl donor supporting liver function, homocysteine metabolism, and exercise performance.",
    category: "Amino Acid",
    ...
    precautions:
      "May cause digestive upset initially. Those with high cholesterol should monitor lipids.",
    scientificInfo:
      "Betaine donates methyl groups to homocysteine, converting it to methionine. Supports cellular hydration as an osmolyte.",
    references: JSON.stringify([

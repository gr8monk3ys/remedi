...
const additionalPharmaceuticals = [
  {
    ...
    usage:
      "Take as directed, typically every 4-6 hours. Do not exceed 4000mg per day.",
  ...
  },
  {
    ...
    warnings:
      "May cause stomach bleeding. Not for children with viral infections.",
    interactions:
      "Interacts with blood thinners, NSAIDs, and certain diabetes medications.",
  },
  {
    fdaId: "mock-8",
    ...
    benefits: ["Allergy relief", "Sleep aid", "Reduces itching"],
    usage:
      "For allergies: 25-50mg every 4-6 hours. For sleep: 50mg before bed.",
    warnings: "May cause drowsiness. Do not operate machinery.",
    interactions:
      "May interact with sedatives, alcohol, and certain antidepressants.",
  },
  {
    fdaId: "mock-9",
    ...
    interactions:
      "May interact with chemotherapy drugs and aluminum-containing medications.",
  },
  {
    fdaId: "mock-10",
    ...
    benefits: ["Bone health", "Heartburn relief", "Calcium supplementation"],
    usage: "Take 500-1000mg with meals, 2-3 times daily.",
    warnings: "May cause constipation. Do not exceed 2500mg daily.",
    interactions:
      "May interfere with absorption of certain antibiotics and thyroid medications.",
  },
];
...
const additionalRemedies = [
  {
    ...
    ingredients: ["Salicin", "White willow bark extract"],
    ...
    precautions:
      "Similar precautions to aspirin. Not for children. Avoid if allergic to aspirin.",
    scientificInfo:
      "Contains salicin, which is converted to salicylic acid in the body, similar to aspirin mechanism.",
    references: [
    ...
    relatedRemedies: ["Aspirin", "Turmeric", "Boswellia"],
  ...
  },
  {
    ...
    benefits: ["Sleep aid", "Reduces anxiety", "Digestive aid"],
    imageUrl:
    ...
    usage:
      "Steep 1-2 tea bags or 1 tablespoon of dried flowers in hot water for 5-10 minutes.",
    dosage: "1-4 cups daily, especially 30 minutes before bed for sleep.",
    precautions:
      "May cause allergic reactions in those sensitive to ragweed. Avoid if pregnant.",
    scientificInfo:
      "Contains apigenin, an antioxidant that binds to benzodiazepine receptors, promoting sleepiness and reducing anxiety.",
    references: [
    ...
    relatedRemedies: ["Valerian Root", "Passionflower", "Lavender"],
    evidenceLevel: "Moderate",
  },
  {
    name: "Citrus Fruits",
    ...
    category: "Food",
    ingredients: ["Vitamin C", "Citric acid", "Flavonoids"],
    benefits: ["Immune support", "Antioxidant", "Skin health"],
    imageUrl:
      "https://images.unsplash.com/photo-1557800636-894a64c1696f?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60",
    sourceUrl: "https://www.healthline.com/nutrition/foods-high-in-vitamin-c",
    usage:
      "Consume 1-2 servings of citrus fruits daily as part of a balanced diet.",
    dosage: "1 medium orange provides about 70mg of vitamin C (78% DV).",
    precautions:
      "High amounts may cause digestive issues. Citrus can interact with some medications.",
    scientificInfo:
      "Rich in vitamin C, which supports immune function, collagen synthesis, and acts as a powerful antioxidant.",
    references: [
      "Carr AC, Maggini S. Vitamin C and Immune Function. Nutrients. 2017;9(11):1211.",
      "Pullar JM, et al. The Roles of Vitamin C in Skin Health. Nutrients. 2017;9(8):866.",
    ],
    relatedRemedies: ["Bell Peppers", "Broccoli", "Strawberries"],
  ...
  },
  {
    ...
    category: "Food",
    ingredients: ["Calcium", "Vitamin K", "Magnesium", "Iron"],
    benefits: ["Bone health", "Heart health", "Nutrient-dense"],
    imageUrl:
    ...
    precautions:
      "High vitamin K content may interfere with blood thinners. Oxalates may affect kidney stones.",
    scientificInfo:
      "Collard greens, kale, and bok choy are excellent plant-based calcium sources with high bioavailability.",
    references: [
    ...
    relatedRemedies: ["Almonds", "Dairy Products", "Fortified Foods"],
    evidenceLevel: "Strong",
  },
  {
    name: "Valerian Root",
    ...
    category: "Herbal Remedy",
    ingredients: ["Valeric acid", "Valerian root extract"],
    benefits: ["Sleep aid", "Reduces anxiety", "Muscle relaxation"],
    imageUrl:
      "https://images.unsplash.com/photo-1597362925123-77861d3fbac7?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60",
    sourceUrl: "https://www.healthline.com/nutrition/valerian-root",
    usage:
      "Typically consumed as tea, tincture, or in capsule form before bedtime.",
    dosage:
      "300-600mg of valerian root extract or 2-3g of dried root 1-2 hours before bed.",
    precautions:
      "May cause drowsiness; avoid driving or operating machinery. Not recommended with alcohol or sedatives.",
    scientificInfo:
      "May increase GABA levels in the brain, which helps regulate nerve cells and has a calming effect.",
    references: [
    ...
    relatedRemedies: ["Chamomile Tea", "Passionflower", "Lemon Balm"],
    evidenceLevel: "Moderate",
  },
];

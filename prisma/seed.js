...
async function main() {
  ...
  const pharmaceuticals = [
    {
      ...
      ingredients: JSON.stringify(['Vitamin D3', 'Calcium', 'Magnesium']),
      benefits: JSON.stringify(['Bone health', 'Immune support', 'Mood regulation']),
    ...
    },
    {
      ...
      benefits: JSON.stringify(['Sleep regulation', 'Jet lag treatment']),
    ...
    },
    {
      ...
      ingredients: JSON.stringify(['EPA', 'DHA', 'Omega-3 fatty acids']),
      benefits: JSON.stringify(['Heart health', 'Brain function', 'Reduces inflammation']),
    ...
    },
    {
      ...
      benefits: JSON.stringify(['Reduces stomach acid', 'Heartburn relief', 'Treats acid reflux']),
  ...
  const naturalRemedies = [
    {
      ...
      ingredients: JSON.stringify(['Sunlight', 'Skin exposure']),
      benefits: JSON.stringify(['Vitamin D production', 'Mood improvement', 'Regulated sleep cycle']),
      ...
      relatedRemedies: JSON.stringify(['Fatty Fish', 'Mushrooms', 'Egg Yolks']),
    ...
    },
    {
      ...
      category: 'Food',
      ingredients: JSON.stringify(['Salmon', 'Mackerel', 'Tuna', 'Omega-3 fatty acids', 'Vitamin D']),
      benefits: JSON.stringify(['Vitamin D intake', 'Heart health', 'Brain function']),
      ...
      relatedRemedies: JSON.stringify(['Fish Oil Supplements', 'Cod Liver Oil', 'Algae Oil']),
      evidenceLevel: 'Strong'
    },
    {
      name: 'Turmeric',
      ...
      category: 'Spice',
      ingredients: JSON.stringify(['Curcumin', 'Turmeric root']),
      benefits: JSON.stringify(['Reduces inflammation', 'Pain relief', 'Antioxidant properties']),
      ...
      relatedRemedies: JSON.stringify(['Ginger', 'Boswellia', 'Willow Bark']),
    ...
    },
    {
      ...
      category: 'Root',
      ingredients: JSON.stringify(['Gingerol', 'Ginger root']),
      benefits: JSON.stringify(['Reduces inflammation', 'Digestive aid', 'Nausea relief']),
    ...
    },
    {
      ...
      category: 'Juice',
      ingredients: JSON.stringify(['Melatonin', 'Anthocyanins', 'Tart cherries']),
      benefits: JSON.stringify(['Sleep improvement', 'Muscle recovery', 'Reduces inflammation']),
      ...
      relatedRemedies: JSON.stringify(['Chamomile Tea', 'Valerian Root', 'Magnesium-Rich Foods']),
      evidenceLevel: 'Moderate'
    }
  ];
  ...
  const mappings = [
    // Vitamin D3 Supplement mappings
    {
      ...
      matchingNutrients: JSON.stringify(['Vitamin D']),
    ...
    },
    {
      ...
      similarityScore: 0.8,
      matchingNutrients: JSON.stringify(['Vitamin D', 'Calcium']),
      replacementType: 'Alternative'
    },
    ...
    // Ibuprofen mappings
    {
      ...
      matchingNutrients: JSON.stringify(['Anti-inflammatory compounds']),
    ...
    // Melatonin mappings
    {
      ...
      matchingNutrients: JSON.stringify(['Melatonin', 'Antioxidants']),
      replacementType: 'Alternative'
    }
  ];

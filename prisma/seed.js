...
async function main() {
  ...
  const pharmaceuticals = [
    {
      ...
      warnings:
        "Excess vitamin D can lead to hypercalcemia. Consult with your healthcare provider.",
      interactions:
        "May interact with certain blood pressure medications and steroids.",
    },
    {
      fdaId: "mock-2",
      name: "Ibuprofen",
      ...
      usage:
        "Take as needed for pain or fever. Do not exceed recommended dosage.",
      warnings:
        "May cause stomach upset or bleeding. Not recommended for long-term use without medical supervision.",
      interactions:
        "May interact with blood thinners, aspirin, and certain heart medications.",
    },
    {
      fdaId: "mock-3",
      name: "Melatonin",
    ...
    },
    {
      ...
      name: "Omeprazole",
      description:
        "Proton pump inhibitor used to treat acid reflux and heartburn",
      ...
      warnings:
        "Long-term use may lead to vitamin B12 deficiency or increased risk of bone fractures.",
      interactions:
        "May reduce absorption of certain medications including some antibiotics.",
    },
  ];
  ...
  const naturalRemedies = [
    {
      ...
      usage:
        "Spend 10-30 minutes in direct sunlight a few times per week, with face and arms exposed.",
      dosage:
        "Varies by skin tone, location, and time of year. Typically 10-30 minutes several times weekly.",
      precautions:
        "Avoid sunburn. Use sunscreen for longer exposure. Not recommended for those with certain skin conditions.",
      scientificInfo:
        "UVB radiation from sunlight converts 7-dehydrocholesterol in the skin to previtamin D3, which is then converted to vitamin D3.",
      references: [
    ...
    },
    {
      ...
      usage:
        "Consume 2-3 servings of fatty fish per week as part of a balanced diet.",
      dosage: "3-4 ounce serving, 2-3 times per week",
      precautions:
        "Be aware of mercury content in certain fish. Not suitable for those with fish allergies.",
      scientificInfo:
        "Fatty fish naturally contains vitamin D3 and omega-3 fatty acids EPA and DHA, which have anti-inflammatory properties.",
      references: [
    ...
    },
    {
      ...
      usage:
        "Add to food or take as supplement. Often combined with black pepper to increase absorption.",
      dosage:
        "500-2,000 mg of turmeric per day, containing 150-180 mg of curcumin.",
      precautions:
        "May interact with blood thinners and diabetes medications. Not recommended before surgery.",
      scientificInfo:
        "Curcumin in turmeric inhibits many molecules involved in inflammation, particularly NF-kB, a molecule that travels into cell nuclei and turns on genes related to inflammation.",
      references: [
    ...
    },
    {
      ...
      precautions:
        "May increase bile production. Caution advised for those with gallbladder disease.",
      scientificInfo:
        "Contains gingerol, which has powerful anti-inflammatory and antioxidant effects. Studies show it may reduce pain and inflammation in conditions like osteoarthritis.",
      references: [
    ...
    },
    {
      ...
      usage:
        "Drink 8-12 oz of tart cherry juice daily, preferably 1-2 hours before bedtime for sleep benefits.",
      dosage: "8-12 oz (240-355 ml) daily",
      precautions:
        "Contains natural sugars; may not be suitable for those monitoring carbohydrate intake.",
      scientificInfo:
        "Contains natural melatonin and has anti-inflammatory properties due to high anthocyanin content.",
      references: [
  ...
  console.log(
    "Creating mappings between pharmaceuticals and natural remedies...",
  );

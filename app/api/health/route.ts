 ...
 */
function determineOverallStatus(services: HealthCheckResponse['services']): HealthCheckResponse['status'] {
...
function getVersion(): string {
  return process.env.npm_package_version || process.env.NEXT_PUBLIC_SENTRY_RELEASE || '0.1.0'
}

    ...
    <AuroraBackground>
      ...
      >
        ...
        <div className="font-extralight text-base md:text-xl dark:text-neutral-200 py-2 text-center max-w-2xl">
          Enter a pharmaceutical drug or supplement to discover natural
          alternatives with similar nutrients and benefits.
        </div>
        <div className="text-sm text-gray-600 dark:text-gray-300 italic text-center max-w-2xl mb-4">
          Our database includes natural remedies for common medications and
          supplements. Click one of the suggested options below or type your own
          search.
        </div>
        ...
        <div className="w-full max-w-2xl mt-10 text-center text-sm text-gray-600 dark:text-gray-300">
          <p>
            This is a demonstration application showing how natural remedies can
            be correlated with pharmaceutical options.
          </p>
          <p className="mt-2">
            Always consult your healthcare provider before making any changes to
            your medication.
          </p>
        </div>
      </motion.div>
